...
namespace EmpPayrollMStest
{
    ...
    public class UnitTest1
    {
        ...
        public void GivenListOfEmployeesWhenAddedToList_ShouldMatchTheEntriesWithoutThreading()
        {
            ...
            employeeList.Add(new EmployeeModel(employeeName: "Nilima", startDate: new System.DateTime(2019, 08, 01), phoneNumber: 9090909090, address: "Bangalore", department: "HR", gender: "F", basicPay: 50000, deductions: 2000, taxablePay: 48000, tax: 1000, netPay: 47000));
            ...
            employeeList.Add(new EmployeeModel(employeeName: "Ankita", startDate: new System.DateTime(2020, 04, 12), phoneNumber: 6097988777, address: "Bangalore", department: "Sales", gender: "F", basicPay: 60000, deductions: 2000, taxablePay: 58000, tax: 1000, netPay: 57000));
            bool expected = true;
        ...
        public void GivenEmployeeList_AddEmployeeListToDatabaseUsingThreads()
        {
            //Arrange
            List<EmployeeModel> employeeList = new List<EmployeeModel>();
            employeeList.Add(new EmployeeModel(employeeName: "Nilima", startDate: new System.DateTime(2019, 08, 01), phoneNumber: 4567876543, address: "Bangalore", department: "HR", gender: "F", basicPay: 50000, deductions: 2000, taxablePay: 48000, tax: 1000, netPay: 47000));
            ...
            employeeList.Add(new EmployeeModel(employeeName: "Ankita", startDate: new System.DateTime(2020, 04, 12), phoneNumber: 4567898754, address: "Bangalore", department: "Sales", gender: "F", basicPay: 60000, deductions: 2000, taxablePay: 58000, tax: 1000, netPay: 57000));
            Stopwatch stopwatch = new Stopwatch();
